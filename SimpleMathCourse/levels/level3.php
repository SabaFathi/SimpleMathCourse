...
<body>
    ...
    <?php
        ...
        $plus_img_src = "http://localhost/SimpleMathCourse/resources/plus.jpg";
        $minus_img_src = "http://localhost/SimpleMathCourse/resources/minus.jpg";
        ...
        if($user_level < $level){
            ...
            switch($operator){
                case "+":
                    echo "<img src=\"$plus_img_src\" width=\"50\" height=\"50\">";
                    break;
                case "-":
                    echo "<img src=\"$minus_img_src\" width=\"50\" height=\"50\">";
                    break;
            }
            echo "<div class=\"line\">";
            ...
            $choices[1] = rand(0, 18);//max value = 9 + 9 = 18
            $choices[2] = rand(0, 18);
            $choices[3] = rand(0, 18);
            shuffle($choices);
